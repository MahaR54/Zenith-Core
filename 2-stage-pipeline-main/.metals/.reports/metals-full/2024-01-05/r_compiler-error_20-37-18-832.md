...
### file%3A%2F%2F%2Fhome%2Fadeia%2FDocuments%2Fsingle%2520cycle%2Fsrc%2Fmain%2Fscala%2Fsinglecycle%2FFetch.scala:24: error: illegal start of simple expression
    PCs:=Mux( Mux( io.inst(31)===1.U,,((io.inst(6,0)==="b1100011".asUInt) & (io.branch===1.S) ))|(io.inst(6,0)==="b1100111".asUInt)|
                                     ^
...
```
scala.meta.internal.parsers.ScalametaParser.simpleExpr0(ScalametaParser.scala:2205)
